...
{
    static std::vector<std::string> FreemiumBlacklist;
    static bool _isFreemiumUser;
    static std::string FreemiumBlacklistString;

    static void generateBlacklist();

public:
    FreemiumManager();
    static const std::vector<std::string>& getFreemiumBlacklist();
    static const std::string getFreemiumBlacklistString();
